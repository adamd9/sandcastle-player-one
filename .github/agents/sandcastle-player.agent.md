...
Your zone is **columns 0–9, rows 0–19** (200 cells). Don't just fill it with blocks — design something.
...
- Left edge: (0,1) to (0,18)
- Right edge: (9,1) to (9,18)

This gives you a protective outer shell. Wind only damages cells on the grid's outer edge (x=0 or y=0/19) — your walls will take the hits so interior blocks don't.
...
- A keep: a solid central structure at roughly (4,9) to (6,11)
